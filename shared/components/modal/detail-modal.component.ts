...
export class DetailModalComponent implements OnInit {
    ...
    public onShare(): void {
        SocialShare.shareText("Hey look at this ticket", "How would you like to share this ticket?");
    }
    ...
    public validation(value: string) {
        if (value == 'valid') {
            this.alert("Thanks for your response. The Ticket has been marked VALID.");
            
        } else {
            this.alert("Thanks for your response. The Ticket has been marked INVALID.");
